...
def can_be_found_updated_and_saved
  ...
  movie_to_change = Movie.find_by(title: "Awesome Flick")
  movie_to_change.title = "Even Awesomer Flick"
...
def can_update_using_update_method
  ...
  movie_to_change = Movie.create(title: "Wat?")
  movie_to_change.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  movie_to_destroy = Movie.find(title: "That One Where the Guy Kicks Another Guy Once")
